...
_0x0:
	...
	.DB  0x20,0x25,0x64,0x20,0x6D,0x0,0x4D,0x4F
	.DB  0x44,0x45,0x3A,0x20,0x43,0x43,0x0,0x53
	.DB  0x45,0x54,0x20,0x54,0x4F,0x20,0x41,0x43
	.DB  0x54,0x49,0x56,0x45,0x0,0x53,0x54,0x41
	.DB  0x54,0x55,0x53,0x3A,0x20,0x50,0x41,0x55
	.DB  0x53,0x45,0x0,0x53,0x54,0x41,0x54,0x55
	.DB  0x53,0x3A,0x20,0x41,0x43,0x54,0x49,0x56
	.DB  0x45,0x0,0x4D,0x4F,0x44,0x45,0x3A,0x20
	.DB  0x4E,0x4F,0x52,0x4D,0x41,0x4C,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 0026     timerOverFlow++;
	LDI  R26,LOW(_timerOverFlow)
	LDI  R27,HIGH(_timerOverFlow)
	CALL SUBOPT_0x0
; 0000 0027 }
	LD   R30,Y+
	OUT  SREG,R30
...
; 0000 0080     timerOverFlow = 0; // Delete timer1 value
	LDI  R30,LOW(0)
	STS  _timerOverFlow,R30
	STS  _timerOverFlow+1,R30
; 0000 0081 
...
; 0000 0083     distance = (unsigned long int)(timerOverFlow*65535 + (ICR1L + ICR1H*256))/466.47;
	LDS  R30,_timerOverFlow
	LDS  R31,_timerOverFlow+1
	LDI  R26,LOW(65535)
	LDI  R27,HIGH(65535)
	CALL __MULW12U
	MOVW R0,R30
